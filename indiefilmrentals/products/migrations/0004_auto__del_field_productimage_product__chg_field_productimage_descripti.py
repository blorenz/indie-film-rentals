...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('products_productimage', 'product_id')


        # Changing field 'ProductImage.description'
        db.alter_column('products_productimage', 'description', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'BaseIndieRentalProduct.ohd_montly'
        db.delete_column('products_baseindierentalproduct', 'ohd_montly')

        # Adding field 'BaseIndieRentalProduct.ohd_monthly'
        db.add_column('products_baseindierentalproduct', 'ohd_monthly',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaseIndieRentalProduct.image'
        db.add_column('products_baseindierentalproduct', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.ProductImage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProductImage.product'
        db.add_column('products_productimage', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['products.BaseIndieRentalProduct']),
                      keep_default=False)


        # Changing field 'ProductImage.description'
        db.alter_column('products_productimage', 'description', self.gf('django.db.models.fields.TextField')(default=''))
        # Adding field 'BaseIndieRentalProduct.ohd_montly'
        db.add_column('products_baseindierentalproduct', 'ohd_montly',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'BaseIndieRentalProduct.ohd_monthly'
        db.delete_column('products_baseindierentalproduct', 'ohd_monthly')

        # Deleting field 'BaseIndieRentalProduct.image'
        db.delete_column('products_baseindierentalproduct', 'image_id')
