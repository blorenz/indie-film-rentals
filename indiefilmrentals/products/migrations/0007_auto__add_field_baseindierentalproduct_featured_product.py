...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseIndieRentalProduct.featured_product'
        db.add_column('products_baseindierentalproduct', 'featured_product',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseIndieRentalProduct.featured_product'
        db.delete_column('products_baseindierentalproduct', 'featured_product')
    ...
    models = {
        ...
        'products.baseindierentalproduct': {
            ...
            'featured_product': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
