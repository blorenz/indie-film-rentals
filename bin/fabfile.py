...
env.hosts = ['indiefilmrentals.example.com']
env.code_dir = '/srv/www/indiefilmrentals'
env.virtualenv = '/srv/www/indiefilmrentals/.virtualenv'
env.code_repo = 'git@github.com:blorenz/indie-film-rentals.git'
env.django_settings_module = 'indiefilmrentals.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/indiefilmrentals/wsgi.py" % env.code_dir)
